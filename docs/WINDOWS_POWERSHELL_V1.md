...
9. Add Windows read-only service, process, and event-log evidence in separate PRs.
10. Packaging/install spike.
11. Later, only after evidence, tests, and review, consider narrowly scoped Windows recipes if a real operator need exists.
